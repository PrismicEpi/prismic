<template>
    <div class="mt-8">
        <div class="flex justify-between items-center mb-4">
            ...
            <router-link to="/historique" class="text-[#7E3AF2] hover:text-[#6C2BD9] flex items-center">
                Voir tout
        ...
        <div class="bg-[#1A1C23] rounded-lg shadow-lg overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                        <tr class="bg-[#232631]">
                            <th class="px-6 py-3 text-left text-xs font-medium text-[#E2E8F0] uppercase tracking-wider">
                                Date</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-[#E2E8F0] uppercase tracking-wider">
                                Caractère</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-[#E2E8F0] uppercase tracking-wider">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-[#E2E8F0] uppercase tracking-wider">
                                Statut</th>
                            <th
                                class="px-6 py-3 text-right text-xs font-medium text-[#E2E8F0] uppercase tracking-wider">
                                Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-[#232631]">
                        <tr v-for="(experiment, index) in recentExperiments" :key="index" class="hover:bg-[#232631]">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-white font-medium">{{
                                experiment.character }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-[#E2E8F0]">
                                <div class="flex space-x-2">
                                    <span class="px-2 py-1 bg-[#232631] rounded text-xs">{{ experiment.voltage
                                    }}V</span>
                                    <span class="px-2 py-1 bg-[#232631] rounded text-xs">{{ experiment.frequency
                                    }}Hz</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="h-2 w-16 bg-gray-700 rounded-full overflow-hidden mr-2">
                                        ...
                                        }" :style="{ width: `${experiment.successRate}%` }"></div>
                                    </div>
                                    <span class="text-sm text-[#E2E8F0]">{{ experiment.successRate }}%</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-[#E2E8F0]">{{ experiment.duration }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
